...
* Linear regression through math seems to be more accurate, because ML ist using 25% less data, thus only 75% of the data for training. Obviously ML has the advantage of assimilating new data by learning.
